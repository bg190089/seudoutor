...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Nova seção Hero baseada no screenshot */}
      <section className="bg-gradient-to-r from-brand-turquoise to-brand-lightblue py-16 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h1 className="text-5xl font-bold mb-4">Saúde de qualidade ainda mais acessível para você</h1>
            <div className="text-2xl max-w-3xl mx-auto">
              Economize em consultas, exames e procedimentos no Dr. Saúde e em toda a rede credenciada a partir de R$
              10/mês.
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 max-w-4xl mx-auto">
            <Link href="/#planos" className="block">
              <Button className="w-full bg-brand-orange hover:bg-brand-orange/90 text-white rounded-full py-6 text-xl font-medium">
                Conheça nossos planos
              </Button>
            </Link>

            <Link href="https://wa.me/557530237676" className="block">
              <Button className="w-full bg-brand-orange hover:bg-brand-orange/90 text-white rounded-full py-6 text-xl font-medium">
                Saiba mais
              </Button>
            </Link>
      ...
      {/* Benefits Section - Mantido da versão anterior */}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-brand-lightblue/10 p-6 rounded-xl text-center hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-semibold text-brand-turquoise mb-2">Atendimento humanizado</h3>
              <p className="text-brand-gray">Atendimento personalizado e de qualidade a partir de R$ 10/mês</p>
            </div>
            ...
            <div className="bg-brand-lightblue/10 p-6 rounded-xl text-center hover:shadow-lg transition-all">
              ...
              <p className="text-brand-gray">
                Rede com profissionais qualificados e estrutura voltada para o bem-estar de toda a família.
              </p>
            </div>
            ...
            <div className="bg-brand-lightblue/10 p-6 rounded-xl text-center hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-semibold text-brand-turquoise mb-2">Zero carência, Zero burocracia</h3>
              <p className="text-brand-gray">
                Zero carência, zero burocracia: solicite agora e comece a usar hoje mesmo.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Plans Section - Invertendo a ordem dos planos */}
      <section id="planos" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Plano Premium - Agora primeiro e com a cor turquesa do manual da marca */}
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Em consultas e exames no Dr Saude</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-brand-turquoise mr-2 mt-0.5" />
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Em até 30 dias após a consulta no Dr Saude</p>
                    </div>
                  </li>
                </ul>
                <div className="mt-8">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="py-3 px-4 text-center text-brand-lightblue">Essencial</th>
                    <th className="py-3 px-4 text-center text-brand-turquoise">Premium</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4 text-brand-gray">Desconto em consultas e exames no Dr Saude</td>
      ...
      {/* How it Works Section - Mantido da versão anterior */}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-brand-gray">Utilize seu cartão no Dr Saude e em toda a rede credenciada.</p>
            </div>
          </div>
        </div>
      </section>

      {/* CTA Section - Texto modificado */}
      <section className="py-16 bg-gradient-to-r from-brand-orange to-brand-yellow text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Adquira agora o Seu Doutor Cartão de Benefícios a partir de R$ 10/mês e comece a economizar em consultas,
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" className="bg-white text-brand-orange hover:bg-white/90" asChild>
              <Link href="https://wa.me/557530237676?text=Olá,%20gostaria%20de%20falar%20com%20um%20consultor%20sobre%20o%20Seu%20Doutor%20Cartão%20de%20Benefícios">
      ...
      {/* FAQ Section - Atualizado com novas perguntas */}
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-brand-gray">
                  ...
                  procedimentos no Dr Saude e em toda a rede credenciada em Feira de Santana e região. Com ele, você
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent className="text-brand-gray">
                  ...
                  laboratoriais no LabSaúde, 5% de desconto em consultas e exames no Dr Saude, e retorno gratuito em até
                  30 dias. O plano Premium custa R$ 15/mês (pagamento anual de R$ 180) e inclui consultas gratuitas e
                  ilimitadas com Clínico Geral, avaliação odontológica gratuita, duas limpezas gratuitas ao ano, 15% de
                  desconto em exames laboratoriais, 5% de desconto em gratuitas ao ano, 15% de desconto em exames
                  laboratoriais, 5% de desconto em consultas e exames no Dr Saude, em exames laboratoriais, 5% de
                  desconto em consultas e exames no Dr Saude, e retorno gratuito em até 30 dias.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-brand-gray">Não pode incluir dependentes.</AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-5">
                <AccordionTrigger className="text-left text-brand-gray">Onde posso utilizar o cartão?</AccordionTrigger>
                <AccordionContent className="text-brand-gray">
                  O cartão pode ser utilizado no Dr Saude, localizado em Feira de Santana, Bahia, e em toda a rede
              ...
              <AccordionItem value="item-6">
                ...
                <AccordionContent className="text-brand-gray">
                  Para agendar, basta entrar em contato com o Dr Saude pelo telefone (75) 3023-7676 ou pelo WhatsApp,
              ...
              <AccordionItem value="item-7">
                <AccordionTrigger className="text-left text-brand-gray">
                  O Cartão seu dr beneficio é um plano de saúde?
                </AccordionTrigger>
                <AccordionContent className="text-brand-gray">
                  Não. O Cartão seu doutor beneficio é uma assinatura de saúde. Diferente de um plano de saúde, não tem
                  o registro de operadora da ANS (Agência Nacional de Saúde) e não dá acesso a procedimentos
                  hospitalares.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
